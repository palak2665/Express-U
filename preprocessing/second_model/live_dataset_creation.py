    ...
    if num_frames < 60:
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 700:
                cv2.imwrite(r"E:\\Documents\\GitHub\\Express-U\\data\\live_dataset\\train\\"+str(element)+"\\" + str(num_imgs_taken) + '.jpg', thresholded)
                if num_imgs_taken <=40:
                  cv2.imwrite(r"E:\\Documents\\GitHub\\Express-U\\data\\live_dataset\\test\\"+str(element)+"\\" + str(num_imgs_taken) + '.jpg', thresholded)
